...
export function UpcomingEvent() {
  ...
  return (
    <Link to={`/${conference.slug}`} className="block w-full max-w-lg">
      <Card className="w-full shadow-lg shadow-primary/20 border-primary/10 transition-shadow hover:shadow-xl hover:shadow-primary/30 cursor-pointer">
        <CardContent className="p-6 flex flex-col gap-4">
          ...
          <span className={cn(buttonVariants({ variant: "default", size: "sm" }), "self-start")}>
            Подробнее →
          </span>
        </CardContent>
      </Card>
